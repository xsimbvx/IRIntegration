# IRIntegration
Данная программа является примером интеграции библиотеки восстановления смазанных и расфокусированных изображений. Для восстановления был выбран [инверсный фильтр] (https://github.com/xsimbvx/ImageRecovery).
